                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5 col-md-8"> 
                        <div class="card shadow rounded border-0">
                            <div class="card-body">
                                <h4 class="card-title text-center">Modification d'utilisateur</h4>                                		                             		                              	
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative" >
                                                    ...
                                                    <input type="text" class="form-control ps-5" placeholder="Nom" name="nom" value='<c:out value="${ utilisateur.nom }"/>' required="" style="padding-left: 1rem!important;">
                                                </div>
                                            </div>
                                        </div><!--end col-->
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative" >
                                                    <i data-feather="mail" class="fea icon-sm icons" style="position: absolute;top: 11px;left: 13px;"></i>
                                                    <input type="text" class="form-control ps-5" placeholder="prenom" name="prenom" value='<c:out value="${ utilisateur.prenom }"/>' required="" style="padding-left: 1rem!important;">
                                                </div>
                                            </div>
                                        </div><!--end col-->       
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div class="form-icon position-relative" >
                                                    <i data-feather="mail" class="fea icon-sm icons" style="position: absolute;top: 11px;left: 13px;"></i>
                                                    <input type="text" class="form-control ps-5" placeholder="Login" name="login" value='<c:out value="${ utilisateur.login }"/>' required="" style="padding-left: 1rem!important;">
                                                </div>
                                            </div>
                                        </div>                       
