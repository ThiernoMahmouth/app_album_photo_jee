		            	...
		            	<div class="row align-items-center">
		            		<div class="col-lg-8 col-md-7">
		            			<div class="section-title">
						            <h5 class="mb-0">Photos dans l'album </h5>
						        </div>
		            		</div>
		            		<div class="card-body">
                                <h4 class="card-title text-center">Album</h4>                                		                             		                              	
                                	
                                    <div class="row">
                                         <div class="col-md-12">
                                            <div class="mb-3">
                                                <p>Nom: <c:out value="${ album.nom }"/></p>
                                                <p>Date création: <c:out value="${ album.date } ${ album.heure }"/></p>
                                            </div>
                                        </div><!--end col-->       
